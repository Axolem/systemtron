...
<br>
    ...
    <img class="image" src="images/about.jfif" alt="">
    <h2  class="heads">OUR MISSION</h2>
    <p class="mine">
    ...
    <img class="image" src="images/mission.jfif" alt="">
    <h2 class="heads">WHERE YOU CAN FIND US</h2>
    <p class="mine">
    ...
    <img class="image" src="images/receptionist.png" alt="">
</div>
