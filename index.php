...
<section class="background">
  ...
  <main>
    ...
    <img class="homeimg" src="images/creativ.jpg" alt="bob-creativ">
    <img class="homeigm" src="images/creative2.jpg" alt="bob-creative2">
    </section>
    <section class="home4">
      <hr size="1"width="100%" color="grey">
      <div class="home3">
       <p><h2>Great Environment , fruitful results </h2></p>
